...
function OffreCard(props) {			  	//must start with an upper case letter
    ...
    const {idService,nom,categorie,creator,prix,address,descri,imgs}=props.offre; 
     return ( 
        <div className="d-flex border m-2 OffreCard " id={idService} onClick={()=>props.history.push("/offres/details/"+idService)}> 
            ...
            <div className="card-body  p-3">
                ...
                <ul className="list-unstyled p-0  ">
                    ...
                    <li className="col-md-12 pl-0 my-0 d-flex" style={{"justify-content":"space-between"}}>
                        <div>
                            <i className="fas fa-dollar-sign text-secondary"></i>{prix}
                        </div>
                        <div>
                            <button className="btn btn-orange py-2">Voir</button>
                        </div>
                    </li>
                </ul> 
            </div>
